...
# this is because the root logger is configured once and in this case this will inside the employee1 module where the level is info because it runs when it's imported.

# this can be solved by setting debug to info but will log into the employee1.log file instead of creating an operations.log file.

# this can be solve creating a logger inside the employee1 module (will be on employee2 for learning purposes)
